...
class AlienInvasion:
    ...
    def _update_bullets(self):
        """Updates the position of the bullets and deletes the old ones"""
    ...
    def _update_aliens(self):
        """
        Check it the fleet is at an edge,
    ...
    def _create_fleet(self):
        ...
        # Determine the number of rows of aliens tjat fit on the screen
